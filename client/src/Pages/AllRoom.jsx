...
const CheakBox = ({ label, Selected = false, onChange = () => {} }) => {
  return (
...
const AllRoom = () => {
  ...
  const roomTypes = ["Single Bed", "Double Bed", "Luxury Romms", "Family Suit"];
  const priceRanges = [
    "0 to 1000",
    "1000 to 2000",
    "2000 to 3500",
          ...
          <React.Fragment key={room._id}>
            ...
            {index < roomsDummyData.length - 1 && (
              <div className="w-full my-6">
                <div className="h-[1px] w-full bg-gray-200 shadow-sm" />
              </div>
            )}
          </React.Fragment>
        ))}
        ...
        >
          ...
          <div className="px-5 pt-5">
            ...
            {priceRanges.map((range, index) => (
              <CheakBox key={index} label={`$ ${range}`} />
            ))}
          </div>
