...
const RoomDetails = () => {
    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
                <h1 className='text-3xl md:text-4xl fomt-playfair'>
            ...
            {/* cheakin cheakout form  */}

            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>

                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-10 text-gray-500'>
                ...
                active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 px-25 py-3 md:py-4 text-base cursor-pointer'>
                  Check Availability
                </button>
            </form>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p >Lorem ipsum dolor, sit amet consectetur adipisicing elit. Labore asperiores quasi eveniet nemo ab omnis voluptates commodi animi non veniam minima, consequuntur delectus ipsum placeat laudantium consequatur pariatur dicta earum at reprehenderit dolorum veritatis tempora et? Animi cupiditate distinctio optio iste eos nisi pariatur numquam, at blanditiis quidem facere modi.</p>
            </div>
                  {/* hosted by */}
