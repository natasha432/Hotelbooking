...
const Sidebar = () => {
  const sidebarLinks = [
    ...
    { name: "ListRooms", path: '/owner/list-rooms', icon: assets.listIcon },             
  ];
  return (
    <div className="md:w-64 w-16 border-r h-full text-base border-gray-300 p-4 flex flex-col transition-all duration-300">
